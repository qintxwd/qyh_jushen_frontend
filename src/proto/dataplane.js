...
export const qyh = $root.qyh = (() => {
    ...
    qyh.dataplane = (function() {
        ...
        dataplane.WebSocketMessage = (function() {
             ...
             * @member {"authRequest"|"authResponse"|"subscribe"|"unsubscribe"|"heartbeat"|"vrControl"|"chassisVelocity"|"jointCommand"|"endEffectorCmd"|"gripperCommand"|"navigationGoal"|"robotState"|"jointState"|"armState"|"chassisState"|"gripperState"|"vrSystemState"|"taskState"|"actuatorState"|"error"|"modeChanged"|"controlChanged"|"emergencyStop"|undefined} payload
             * @memberof qyh.dataplane.WebSocketMessage
             * @instance
             */
            Object.defineProperty(WebSocketMessage.prototype, "payload", {
                get: $util.oneOfGetter($oneOfFields = ["authRequest", "authResponse", "subscribe", "unsubscribe", "heartbeat", "vrControl", "chassisVelocity", "jointCommand", "endEffectorCmd", "gripperCommand", "navigationGoal", "robotState", "jointState", "armState", "chassisState", "gripperState", "vrSystemState", "taskState", "actuatorState", "error", "modeChanged", "controlChanged", "emergencyStop"]),
